...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Tech Group</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  Tech Group
                  <small>Member since D. 2017</small>
                </p>
              </li>
              <!-- Menu Footer-->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date("Y"); ?> <a target="_blank" href="https://techgroup.co">Techo Group</a>.</strong> All rights
    reserved.
  </footer>
          ...
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                ...
                <p>New phone +880 190-000 0000</p>
              </div>
            </a>
          </li>
          <li>
